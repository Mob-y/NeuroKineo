...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <Navbar showBack title="Nous contacter" />
      ...
      <main className="flex-1 p-4 max-w-lg mx-auto w-full pt-6">
        ...
        {!envoye ? (
          <>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 mb-4">
              <div className="mb-3">
                ...
                <input id="nom" type="text" placeholder="Ton nom" value={nom}
                  onChange={e => setNom(e.target.value)} className={inputClass} />
              </div>
              <div className="mb-3">
              ...
              <div className="mb-3">
                ...
                <select id="sujet" value={sujet} onChange={e => setSujet(e.target.value)} className={inputClass}>
              ...
              <div className="mb-1">
                ...
                <textarea id="message" placeholder="Ton message..." value={message}
          ...
          <div className="flex flex-col items-center justify-center flex-1 py-16 text-center">
            ...
            <p className="text-slate-400 text-sm mb-6">Merci pour ton message. On te répondra dans les plus brefs délais.</p>
            <button type="button" onClick={() => router.push('/accueil')}
