        ...
        <div className="bg-white rounded-2xl shadow-md p-8 w-full max-w-md">
          ...
          {isInscription && (
            <>
              ...
              <select value={annee} onChange={e => setAnnee(e.target.value)} className={inputClass}>
              ...
              <input type="text" placeholder="Nom de l'école" value={ecole} onChange={e => setEcole(e.target.value)} className={inputClass} />
            </>
          )}

          {/* Email & Mot de passe */}
          <input type="email" placeholder="Email" value={email} onChange={e => setEmail(e.target.value)} onKeyDown={handleKeyDown} className={inputClass} />
          <input type="password" placeholder="Mot de passe" value={password} onChange={e => setPassword(e.target.value)} onKeyDown={handleKeyDown} className={inputClass} />
